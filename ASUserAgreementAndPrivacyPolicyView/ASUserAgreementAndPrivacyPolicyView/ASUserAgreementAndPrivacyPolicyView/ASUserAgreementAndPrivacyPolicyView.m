...
- (instancetype)showUserAgreementAndPrivacyPolicyView {
...
+ (instancetype)showUserAgreementAndPrivacyPolicyViewIsAgreeOperation:(void (^)(BOOL))isAgreeOperation {
    ...
    if (_userAgreementAndPrivacyPolicyView == nil) {
        ...
        _userAgreementAndPrivacyPolicyView = [[self alloc] showUserAgreementAndPrivacyPolicyView];
...
- (void)setupUI {
    ...
    CGSize mainViewSize = CGSizeMake(500, 350);
